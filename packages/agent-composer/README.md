# @nucleux/agent-composer

Agent task composer with toolbar — Nucleux agentic UI for React.
...
```bash
pnpm add @nucleux/agent-composer @nucleux/tokens
```
...
```tsx
import { AgentComposer } from "@nucleux/agent-composer";
```
