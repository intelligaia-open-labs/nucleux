# @nucleux/rewrite-menu

RewriteMenu — a menu of AI rewrite and transform actions — Nucleux agentic UI for React.
...
```bash
pnpm add @nucleux/rewrite-menu @nucleux/tokens
```
...
```tsx
import { RewriteMenu } from "@nucleux/rewrite-menu";
```
