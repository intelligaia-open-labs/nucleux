...
/**
 * End-to-end composition of the "Meeting dashboard" home screen, assembled
 * entirely from Nucleux primitives — a faithful implementation of the source
 * Figma design (AI-UX-Pattern › Body). This is an example, not a shipped
 * component: it demonstrates how the primitives compose into a real screen.
 */
const meta = {
...
function CaptureAnotherMeeting() {
  return (
